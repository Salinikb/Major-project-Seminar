...
<body>
	<!--background-->
	<!--<h1>Please help us to serve you better by taking a couple of minutes.</h1>--->
    <h1></h1>
	<div class="booking-form-w3layouts">
		<!-- Form starts here -->
		<form action="#" method="post">
			<h2 class="sub-heading-agileits">Give your feedback</h2>
			<h3>Please help us to serve you better by taking a couple of minutes. </h3>
			<div class="radio-section">
				<h6>Select your Fare</h6>
				<ul class="radio-buttons-w3-agileits">
					<li>
						<input type="radio" id="view" name="view" value="Excellent">
						<label for="a-option">Excellent</label>
						<div class="check"></div>
					</li>
					<li>
						<input type="radio" id="view" name="view" value="Good">
                    ...
                    <input type="radio" id="view" name="view" value="Poor">
