                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Flight details</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="shoes.html">View users</a></li>
											<li id="menu-academico-avaliacoes" ><a href="products.html">View payment status</a></li>
											<li id="menu-academico-boletim" ><a href="sunglasses.html">Feedback</a></li>
										  </ul>
										</li>
										 <li id="menu-academico" ><a href="users.php"><i class="fa fa-file-text-o"></i> <span>View Users</span></a></li>
									<li><a href="sweater.html"><i class="lnr lnr-pencil"></i> <span>seat arrangement</span></a></li>
									<li id="menu-academico" ><a href="catalog.html"><i class="fa fa-file-text-o"></i> <span>Booking Status</span></a></li>
									<li id="menu-academico" ><a href="shoes.html"><i class="lnr lnr-book"></i> <span>Feedback</span></a></li>
									 <li><a href="bags.html"><i class="lnr lnr-envelope"></i> <span>Paymentstatus</span></a></li>
									<li><a href="products.html"><i class="lnr lnr-chart-bars"></i> <span>users</span></a></li>
