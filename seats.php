...
<link href="cssseats/style.css" rel="stylesheet" type="text/css" media="all" />
<script src="jsseats/jquery-1.11.0.min.js"></script>
<script src="jsseats/jquery.seat-charts.js"></script>
</head>
<body>
<div style="width: 90%; border-radius: 10px; border: 1px solid grey; margin-left: 60px; padding: 10px;">
...
<div class="content">
	...
	<p class="copy_rights"> <a href="http://w3layouts.com/" target="_blank"> </a></p>
</div>
<script src="jsseats/jquery.nicescroll.js"></script>
<script src="jsseats/scripts.js"></script>
