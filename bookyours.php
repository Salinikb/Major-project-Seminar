						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="#"><i class="fa fa-tachometer"></i> <span>View All flights</span></a></li>
										<li><a href="preferedbooked.php"><i class="fa fa-tachometer"></i> <span>Bookings</span></a></li>
										<li><a href="packages.php"><i class="fa fa-tachometer"></i> <span>view offers</span></a></li>
   	 	...
   	 	<table>
			  ...
			  ?>
                 ...
                 <td class="text-right">
   	 	     		...
   	 	     		<div class="close-btm">
   	 	     	 <a href="cart1.php?id=<?php echo $row['id']?>"> <h5>Book your seats</h5>
   	 	        </div>
   	 	     	</td>
